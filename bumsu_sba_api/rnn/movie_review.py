import os
from bumsu_sba_api.utils.file_helper import FileReader
from bumsu_sba_api.utils.checker import is_number
...
class MovieReview:
    ...
    def hook(self):
        print('==== Hook ====')
        self.train()
        print(self.classify('쓰레기'))

    def load_corpus(self):
        reader = self.reader
        corpus = read_table('bumsu_sba_api/rnn/data/movie_review.csv', sep=',', encoding='UTF-8')
